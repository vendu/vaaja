#ifndef SYS_TAIKA_UTIL_H
#define SYS_TAIKA_UTIL_H

#include <taika/fastudiv.h>
extern struct divu16            k_fastu16divu16tab[SCHED_ULE_DIVU16TAB_SIZE] C_ALIGNED(MACH_PAGE_SIZE);


#define EOF                     (-1)

#define taikasrand(seed)        (srandmt32(seed))
#define taikaurand()            (randmt32())
