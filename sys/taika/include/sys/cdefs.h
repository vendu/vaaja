...
#define C_FASTCALL                      __attribute__ ((regparm(3)))
#define C_FASTFLOAT                     __attribute__ ((sseregparm(3)))
#define C_ASMLINK                       __attribute__ ((regparm(0)))
...
#define C_INLINE                        __attribute__ ((__always_inline__))
...
#define C_RETURNS_TWICE                 __attribute__ ((__returns_twice__))
