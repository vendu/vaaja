#ifndef MACH_V0_TRAP_H
#define MACH_V0_TRAP_H

#define v0trapisirq(t)          ((t) & V0_IRQ_TRAP_BIT)
...
#define V0_DEV1_TRAP            V0_IRQ_0x0a_TRAP    // miscellaneous devices
#define V0_DEV2_TRAP            V0_IRQ_0x0b_TRAP
#define V0_DEV3_TRAP            V0_IRQ_0x0c_TRAP
#define V0_DEV4_TRAP            V0_IRQ_0x0d_TRAP
#define V0_DEV5_TRAP            V0_IRQ_0x0e_TRAP
#define V0_DEV6_TRAP            V0_IRQ_0x0f_TRAP

/* IV-register contents */

/* v0trapfunc */
#define V0_SYS_TRAP_BIT         (1 << 0)        // system-mode trap
#define V0_STK_TRAP_BIT         (1 << 1)        // traps on separate stack
#define V0_TRAP_ADR_MASK        0fffffffc      // trap function pointer
...
#define V0_PF_SYS               (1 << 3)        // page-fault with system page
