...
/*
 * logical functions/operations; struct v0inst
 * - V0_NOT_OP:   parm & V0_NOT_BIT
 * - V0_ORR_OP:   parm & V0_ORR_BIT
 * - V0_XOR_OP:   parm & V0_XOR_BIT
 * - V0_AND_OP:   parm & V0_AND_BIT
 * - V0_NOR_OP:   parm & V0_NOR_BIT
 * - V0_XNOR_OP:  parm & V0_XNOR_BIT
 * - V0_NAND_OP:  parm & V0_NAND_BIT
 */
...
#define V0_NOT_BIT              0x00
#define V0_ORR_BIT              0x01
#define V0_XOR_BIT              0x02
#define V0_AND_BIT              0x03
#define V0_NOR_BIT              0x04
#define V0_XNOR_BIT             0x05
#define V0_NAND_BIT             0X06
/* 0x07 is reserved */

/*
 * bit-operations; struct v0inst
 * - all of these support atomic operations (ATOMIC-bit set)
 *   - the original bit is returned in the CF-bit of MSW
 * - V0_TST_OP:   parm & V0_TST_BIT
 * - V0_SET_OP:   parm & V0_SET_BIT
 * - V0_CLR_OP:   parm & V0_CLR_BIT
 * - V0_FLP_OP:   parm & V0_FLP_IBT
 */
...
#define V0_TST_BIT              0x00
#define V0_SET_BIT              0x01
#define V0_CLR_BIT              0x02
#define V0_FLP_BIT              0x03

/*
 * shift operations
 * - V0_SHL_OP:   parm & V0_SHL_BIT
 * - V0_SHR_OP:   parm & V0_SHR_BIT
 * - V0_SAR_OP:   parm & V0_SAR_BIT
 */
...
#define V0_SHL_BIT              0x00
#define V0_SHR_BIT              0x01
#define V0_SAR_BIT              0x02
...
#define V0_UIRP_OP              V0_IRP_OP   // dest = uirp(src);
...
#define V0_REV_BIT              0x01

/*
 * bit-count operations
 * - V0_CTZ_OP:   parm & V0_CTZ_BIT
 * - V0_CLZ_OP:   parm & V0_CLZ_BIT
 * - V0_HAM_OP:   parm & V0_HAM_BIT
 * - V0_PAR_OP:   parm & V0_PAR_BIT
 */
...
#define V0_CTZ_BIT              0x00
#define V0_CLZ_BIT              0x01
#define V0_HAM_BIT              0x02
#define V0_PAR_BIT              0x03
...
#define V0_JAL_OP               JMP_OP      // parm & V0_LINK_BIT
...
#define V0_REP_OP               V0_BRA_OP   // jump, cond=V0_NZ_COND (cnt > 1)
...
#define V0_STK_OP               0x19        // stack operation
#define V0_PSH_OP               V0_STK_OP   // sp -= 4; *sp = src;
#define V0_POP_OP               V0_STK_OP   // dest = *sp; sp += 4;
#define V0_STM_OP               V0_STK_OP   // push multiple registers
#define V0_LDM_OP               V0_STK_OP   // pop multiple registers
#define V0_PSH_BIT              0x01
#define V0_POP_BIT              0x02
#define V0_STM_BIT              0x04
#define V0_LDM_BIT              0x08

/* I/O operations */
#define V0_IOP_OP               0x1a        // permission control
#define V0_IOC_OP               0x1b        // I/O commands
#define V0_IOR_OP               0x1c        // I/O-port reads
#define V0_IOW_OP               0x1d        // I/O-port writes
/* 0x1e and 0x1f are reserved */
...
#define V0_CAS_OP               0x27        // compare-and-swap [ATOMIC-bit]
...
/*
 * size-field; operand size
 * - shift count for 1 [byte]
 *   - 0 for byte (8-bit)
 *   - 1 for halfword (16-bit)
 *   - 2 for word (32-bit)
 *   - 3 for longword (32-bit)
 */
#define V0_BYTE_SIZE            0x00
#define V0_HALF_SIZE            0x01
#define V0_WORD_SIZE            0x02
#define V0_LONG_SIZE            0x03
#define V0_VECTOR_BIT           0x04
#define V0_VECTOR128_SIZE       0x05
#define V0_VECTOR256_SIZE       0x06
#define V0_VECTOR512_SIZE       0x07
...
#define V0_IMM_ADR_BIT          (1 << 0)    // denotes argument in imm32
#define V0_BASE_ADR_BIT         (1 << 1)    // denotes base-address in src/dest
#define V0_OFS_ADR_BIT          (1 << 2)    // denotes address-offset in arg
...
#define V0_SEX_BIT              (1 << 1)    // 0: zero-extend, 1: sign-extend
//#define V0_STORE_BIT            (1 << 3)    // PSH, STM
#define V0_SHIFT_BITS           6           // # of bits in shift counts
#define V0_ATOMIC_BIT           (1 << 2)    // atomic [memory] operation
#define V0_REV_BIT              (1 << 2)    // reverse bits; HUN
//#define V0_LINK_BIT             (1 << 6)    // JAL
#define V0_UNSIGNED_BIT         (1 << 3)    // perform unsigned operation
#define V0_RET64_BIT            (1 << 4)    // return full 64-bit longword in R1
