...
CFLAGS+="-Werror -Wundef -D__v0__ -D__zen__ -g -nostdlib --freestanding"
CCOPTFLAGS="-O"
...
gcc $CFLAGS $CCOPTFLAGS $CCWARNFLAGS -I../.. -I../../usr/lib -o zen *.c sched/*.c net/*.c ../../usr/lib/zen/fastudiv16.c -pthread
