...
#define ZEN_KEY_EV_MASK         ZEN_EV_MASK(ZEN_KEY_PRESS_BIT           \
                                            | ZEN_KEY_RELEASE_BIT)
...
long   zenpeekev(struct zenev *ev, long mask);
/*
...
/* flg-argument bits for zensyncev() */
...
#define ZEN_EV_MSG_MAX          (sizeof(zenevword_t) + 8)
#define ZEN_MAX_EV_SIZE         (offsetof(struct zenev, msg) + ZEN_EV_MSG_MAX)
/* event structure */
struct zenev {
    struct zenevhdr             hdr;
    union {
