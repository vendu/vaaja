...
#define MJOLNIR_ITEM_JACK               '0'
#define MJOLRNIR_ITEM_DECK_UPGRADE      '1'
#define MJOLNIR_ELECTRONIC_DEVICE       '6'
#define MJOLNIR_ITEM_PERSONAL_CARD      '-'
#define MJOLNIR_ITEM_ATM_MACHINE        'C'
#define MJOLNIR_ITEM_ID_CARD            'i'
#define MJOLNIR_ITEM_BOOK               '9'
#define MJOLNIR_ITEM_BEEHIVE            'B'
#define MJOLNIR_ITEM_CARVING            'c'
