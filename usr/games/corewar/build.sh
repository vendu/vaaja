...
CCPKGFLAGS="-DZEUS=1 -DZEUSWINX11 -DZEUSIMLIB2=1 -DZEUSDEBUG=1"
...
gcc -g $CCWARNFLAGS $CCPKGFLAGS -I../../lib -I.. -O -g -o zeus cw.c rc.c zeus.c zeus-x11.c -lX11 -lImlib2 -pthread
