...
#define V0_FTR_OP       0x00    // check machine feature
#define V0_HLT_OP       0x01    // halt, wait for interrupts in mask
#define V0_RST_OP       0x02    // reset, hibernate, reboot
#define V0_CLI_OP       0x03    // mask all or given interrupts from bitmap
#define V0_STI_OP       0x04    // unmask all or given interrupts from bitmap
#define V0_SIM_OP       0x05    // set interrupt mask
#define V0_INT_OP       0x06    // deliver interrupt
#define V0_RTI_OP       0x07    // return from interrupt
#define V0_DEV_OP       0x08    // [bus and] device operations
#define V0_ROM_OP       0x09    // LIST, LOAD, RUN, TERM, ...
#define V0_CSP_OP       0x0a    // set cache policy (NONE, WT, WB)
#define V0_CPF_OP       0x0b    // cacheline prefetch
#define V0_RBR_OP       0x0c    // memory read-barrier
#define V0_WBR_OP       0x0d    // memory write-barrier
#define V0_BAR_OP       0x0e    // full memory barrier

/* MT-extension unit 0x01 */
...
#define V0_UADD_OP      0x01    // addition (ignore overflow)
...
#define V0_PARM_REG_MASK        0x0f00
/* addressing-mode flags */
#define V0_PARM_ADR_NDX_BIT     0x1000
#define V0_PARM_ADR_OFS_BIT     0x2000
/* operand-size flags */
#define V0_PARM_OPSIZE_BIT_1    0x4000
#define V0_PARM_OPSIZE_BIT_2    0x8000
/* (extra) register/memory transfer directions */
#define V0_XFER_DIR_MASK        0x7000
#define V0_PARM_RTOX_BIT        0x0000
#define V0_PARM_XTOR_BIT        0x1000
#define V0_PARM_XTOM_BIT        0x2000
#define V0_PARM_MTOX_BIT        0x4000
#define V0_PARM_RTOR_BIT        0x0000
#define V0_PARM_RTOM_BIT        0x1000
#define V0_PARM_MTOR_BIT        0x2000
struct v0ins {
